...
describe('route sorter', () => {
    it('sorts routes', () => {
        ...
        const sortedEndpoints = Object.entries(routes).sort((a, b) => (0, __1.compareRoute)(a[1], b[1]));
        if (sortedEndpoints[5][0] === 'removeById') {
            (0, testlab_1.expect)(sortedEndpoints).to.eql([
...
//# sourceMappingURL=route-sort.unit.js.map